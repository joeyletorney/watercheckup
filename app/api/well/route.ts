...
const WELL_PRODUCTS = [
  ...
  {
    name: 'iSpring WCFM500K Iron, Manganese & Sulfur',
    brand: 'iSpring',
    price: 2299,
    rating: 4.6,
    reviews: 420,
    cert: 'WQA tested (manufacturer); iron/manganese/H₂S per specs',
    removes: ['Iron up to 12 ppm','Manganese','Hydrogen sulfide','Rotten-egg odor'],
    bestFor: 'High iron, manganese, and sulfur smell — common rural well issues',
    pros: ['Whole-house POE media','Long media life','Designed for well chemistry'],
    asin: 'B08TMZYYQY',
    tag: 'watercheck20-20',
  },
  {
