...
function buildWeeklyHtml(issue: Issue): string {
  ...
  <div style="max-width:620px;margin:0 auto;padding:32px 24px;background:#ffffff">
    ...
    <div style="margin-top:24px;padding-top:16px;border-top:1px solid #e2e8f0;font-size:11px;color:#94a3b8;line-height:1.6">You're receiving this because you subscribed at watercheckup.com. We send one email per week, no spam. Reply to unsubscribe at any time.</div>
  </div>
  </body></html>`;
}
