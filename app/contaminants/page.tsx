...
const CONTAMINANTS = [
  ...
  },
  {
    ...
    what: 'This group includes synthetic organic chemicals used in farming, turf management, and pest control that can reach groundwater and surface water through runoff, spray drift, and leaching. EPA sets individual limits for specific pesticides (such as atrazine, 2,4-D, alachlor, and others) under the Safe Drinking Water Act. Presence depends heavily on land use, season, and your public water system’s source water.',
