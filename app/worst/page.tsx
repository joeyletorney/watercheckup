      ...
      <div style={{ maxWidth: 760, margin: '0 auto', padding: '48px 24px 80px' }}>
        <div style={{ marginBottom: 36 }}>
          ...
          <p style={{ fontSize: 15, color: '#94a3b8', lineHeight: 1.7, margin: 0 }}>
            Every page below pulls from EPA monitoring (UCMR5), Safe Drinking Water Information System violations, or structured profiles across 432,000+ water systems. Use this hub to navigate stories that are designed to rank in search and hold up to scrutiny.
          </p>
        </div>
