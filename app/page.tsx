...
const PRODUCTS: any[] = [
  ...
  // ── FAUCET MOUNT ────────────────────────────────────────────────────────────
  { id:13, cat:'faucet', catLabel:'Faucet Mount', name:'PUR PLUS Faucet Mount FM2000B', brand:'PUR', price:35, filterCostPerYear:80, rating:4.5, reviews:28000, gpd:null, stages:3, cert:['NSF/ANSI 42','NSF/ANSI 53'], certColor:'#22d3ee', removes:['Lead 99%','Arsenic 96%','Mercury','Chlorine','Microbial cysts'], bestFor:['Lead','Arsenic','Mercury','Chlorine'], pros:['Attaches to faucet','No permanent install','One-click on/off'], diyDiff:'Easy', situations:['renter','family','dorm'], img:'', amazon:`https://www.amazon.com/dp/B009V9K6BY?tag=${TAG}` },
  ...
  { id:17, cat:'bottle', catLabel:'Filtered Water Bottle', name:'Berkey Sport Bottle', brand:'Berkey', price:35, filterCostPerYear:15, rating:4.5, reviews:4200, gpd:null, stages:2, cert:['EPA WQA tested'], certColor:'#475569', removes:['Bacteria >99.9%','Viruses >99.9%','Chlorine','Heavy metals'], bestFor:['Bacteria','Viruses','Lead','Chlorine'], pros:['Works on any water source','Zero waste','Budget-friendly'], diyDiff:'None', situations:['dorm','travel'], img:'', amazon:`https://www.amazon.com/dp/B0006VTRIY?tag=${TAG}` },
