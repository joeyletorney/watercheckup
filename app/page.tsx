...
const PRODUCTS = [
  // ── PITCHER ──────────────────────────────────────────────────────────────────
  { id:1,  category:'pitcher',     name:'PUR PLUS 11-Cup Pitcher',      brand:'PUR',                type:'Pitcher Filter',               price:42,  filterCostPerYear:110, rating:4.5, reviews:22000, gpd:null, stages:3, cert:['NSF/ANSI 42','NSF/ANSI 53'],                                                certColor:'#22d3ee', removes:['Lead 100%','Arsenic 100%','Uranium 100%','Chlorine','PFNA 96%'],        bestFor:['Lead','Arsenic','Uranium','Chromium-6'], pros:['No install needed','Portable','Removes 70+ contaminants'],          quickChange:true,  expertPick:true,  expertReason:'Rated #1 by Consumer Reports. NSF-certified to remove lead, PFNA & 70+ contaminants — outperforms Brita in independent heavy-metal tests.',       img:'https://m.media-amazon.com/images/I/71Pg8yZLLfL._AC_SL1500_.jpg',  amazon:`https://www.amazon.com/dp/B07NMQNHPB?tag=${TAG}`,    pitcher:true },
  { id:2,  category:'pitcher',     name:'Brita Standard 10-Cup',        brand:'Brita',              type:'Pitcher Filter',               price:30,  filterCostPerYear:60,  rating:4.6, reviews:98000, gpd:null, stages:2, cert:['NSF/ANSI 42','NSF/ANSI 53'],                                                certColor:'#22d3ee', removes:['Chlorine taste & odor','Mercury','Cadmium','Copper'],           bestFor:['Chlorine','Copper','Mercury'],           pros:['Most popular pitcher in the US','BPA-free','Slim design'],          quickChange:true,  expertPick:false, expertReason:'',                                                                                                                                              img:'https://m.media-amazon.com/images/I/71gvUcpgVeL._AC_SL1500_.jpg',  amazon:`https://www.amazon.com/s?k=Brita+Standard+10+Cup+Pitcher&tag=${TAG}`,         pitcher:true },
  { id:3,  category:'pitcher',     name:'ZeroWater 10-Cup Pitcher',     brand:'ZeroWater',          type:'Pitcher Filter — 5-Stage',     price:35,  filterCostPerYear:120, rating:4.4, reviews:31000, gpd:null, stages:5, cert:['NSF/ANSI 42','NSF/ANSI 53'],                                                certColor:'#22d3ee', removes:['TDS 99.6%','Lead','Chromium','Fluoride','PFOA/PFOS'],         bestFor:['Lead','Fluoride','Chromium-6','TDS'],    pros:['Removes virtually all TDS','Includes TDS meter'],                   quickChange:true,  expertPick:false, expertReason:'',                                                                                                                                              img:'https://m.media-amazon.com/images/I/71qy7PBEX6L._AC_SL1500_.jpg',  amazon:`https://www.amazon.com/s?k=ZeroWater+10+Cup+Pitcher&tag=${TAG}`,             pitcher:true },
  // ── COUNTERTOP ───────────────────────────────────────────────────────────────
  { id:4,  category:'countertop',  name:'Big Berkey Gravity Filter',    brand:'Berkey',             type:'Countertop Gravity Filter',    price:358, filterCostPerYear:30,  rating:4.8, reviews:12000, gpd:null, stages:2, cert:['NSF-equivalent tested'],                                                     certColor:'#d97706', removes:['Viruses >99.9%','Lead >99.9%','Chlorine','Fluoride (add-on)','PFAS'], bestFor:['Lead','Viruses','Bacteria','Chlorine'], pros:['No electricity or plumbing','Off-grid ready','6,000-gal filter life'],quickChange:false, expertPick:true,  expertReason:'Highest gravity-filter rating on Amazon (4.8★, 12,000+ reviews). Independently lab-tested by Envirotek Labs. Go-to recommendation from off-grid & emergency-prep communities.', img:'https://m.media-amazon.com/images/I/61lAmfQPBaL._AC_SL1500_.jpg',  amazon:`https://www.amazon.com/s?k=Big+Berkey+Gravity+Water+Filter&tag=${TAG}`,   countertop:true },
  { id:5,  category:'countertop',  name:'Waterdrop Countertop RO',      brand:'Waterdrop',          type:'Countertop Reverse Osmosis',   price:299, filterCostPerYear:100, rating:4.7, reviews:5400,  gpd:400, stages:9, cert:['NSF/ANSI 42','NSF/ANSI 58'],                                                certColor:'#22d3ee', removes:['PFAS >99%','Lead >99%','Fluoride','Arsenic','TDS'],           bestFor:['PFAS','Lead','Arsenic','Fluoride'],      pros:['No plumbing needed','400 GPD','Twist-lock quick-change filters'],   quickChange:true,  expertPick:false, expertReason:'',                                                                                                                                              img:'https://m.media-amazon.com/images/I/61GRGiCFPdL._AC_SL1500_.jpg',  amazon:`https://www.amazon.com/s?k=Waterdrop+Countertop+RO+System&tag=${TAG}`,    countertop:true },
  // ── UNDER-SINK RO ────────────────────────────────────────────────────────────
  { id:6,  category:'undersink',   name:'Waterdrop G3P800',             brand:'Waterdrop',          type:'Tankless Under-Sink RO',       price:449, filterCostPerYear:170, rating:4.8, reviews:9800,  gpd:800, stages:8, cert:['NSF/ANSI 42','NSF/ANSI 53','NSF/ANSI 58','NSF/ANSI 372'],                   certColor:'#22d3ee', removes:['PFAS >99%','Lead >99%','Fluoride','Chlorine','Heavy metals'],   bestFor:['PFAS','Lead','Arsenic','Chromium-6'],    pros:['No tank — compact','800 GPD','Twist-lock encapsulated filters'],    quickChange:true,  expertPick:true,  expertReason:'Top-rated tankless RO on Amazon (4.8★). Quick-twist encapsulated filters — no messy housings. Named best no-tank system by multiple independent review sites.',           img:'https://m.media-amazon.com/images/I/61Y0jVJoVxL._AC_SL1500_.jpg',  amazon:`https://www.amazon.com/dp/B07P1XFYJP?tag=${TAG}`,    tankless:true,  remineralize:false },
  { id:7,  category:'undersink',   name:'APEC ROES-50',                 brand:'APEC Water Systems', type:'Under-Sink RO',               price:219, filterCostPerYear:95,  rating:4.7, reviews:28400, gpd:50,  stages:5, cert:['WQA Gold Seal','NSF/ANSI 58'],                                               certColor:'#d97706', removes:['Lead >99%','Arsenic >99%','Fluoride >96%','Chlorine >98%','TDS >93%'], bestFor:['Lead','Arsenic','Fluoride','Nitrate','Copper'], pros:['Made in USA','20yr track record','Budget-friendly'],              quickChange:false, expertPick:false, expertReason:'',                                                                                                                                              img:'https://m.media-amazon.com/images/I/61cF0FQEDBL._AC_SL1500_.jpg',  amazon:`https://www.amazon.com/dp/B00I0ZGOZM?tag=${TAG}`,    tankless:false, remineralize:false },
  { id:8,  category:'undersink',   name:'iSpring RCC7AK',               brand:'iSpring',            type:'Under-Sink RO + Alkaline',    price:229, filterCostPerYear:80,  rating:4.7, reviews:14200, gpd:75,  stages:6, cert:['NSF/ANSI 42','NSF/ANSI 53','NSF/ANSI 58'],                                  certColor:'#22d3ee', removes:['Lead >98.9%','PFAS >96%','Chromium >99%','Fluoride >97%','TDS >93%'], bestFor:['Lead','PFAS','Chromium-6','Copper','Nitrate'], pros:['Triple NSF certified','Remineralizes water','75 GPD'],          quickChange:false, expertPick:false, expertReason:'',                                                                                                                                              img:'https://m.media-amazon.com/images/I/71RKD7DEYBL._AC_SL1500_.jpg',  amazon:`https://www.amazon.com/dp/B005LJ8EXU?tag=${TAG}`,    tankless:false, remineralize:true },
  { id:9,  category:'undersink',   name:'Aquasana SmartFlow RO',        brand:'Aquasana',           type:'Under-Sink RO + Claryum',     price:449, filterCostPerYear:145, rating:4.7, reviews:2100,  gpd:50,  stages:5, cert:['WQA Gold Seal','NSF/ANSI 42','NSF/ANSI 53','NSF/ANSI 58','NSF/ANSI 401'],    certColor:'#d97706', removes:['90+ contaminants','Fluoride 90%','Lead >99%','Microplastics','PFAS'],  bestFor:['PFAS','Lead','Fluoride','Microplastics'], pros:['Most certifications','Retains healthy minerals'],                  quickChange:true,  expertPick:false, expertReason:'',                                                                                                                                              img:'https://m.media-amazon.com/images/I/71gFCKKMNwL._AC_SL1500_.jpg',  amazon:`https://www.amazon.com/dp/B01AO49OAQ?tag=${TAG}`,    tankless:false, remineralize:true },
  // ── WHOLE HOUSE ──────────────────────────────────────────────────────────────
  { id:10, category:'whole-house', name:'Pelican PC600',                 brand:'Pelican Water',      type:'Whole-House Carbon Filter',    price:899, filterCostPerYear:120, rating:4.7, reviews:1800,  gpd:null, stages:3, cert:['NSF/ANSI 42','NSF/ANSI 61','WQA Gold Seal'],                              certColor:'#d97706', removes:['Chlorine >97%','Chloramine','THMs','VOCs','Sediment'],        bestFor:['Chloramine','Chloroform','HAAs','VOCs'],  pros:['Whole house','No salt','6-year filter life','Zero maintenance'],    quickChange:false, expertPick:true,  expertReason:'WQA Gold Seal certified — highest long-term owner satisfaction in its category. Salt-free, no backwash, and a 6-year filter life praised across thousands of independent reviews.', img:'https://m.media-amazon.com/images/I/81r1fLVQbwL._AC_SL1500_.jpg',  amazon:`https://www.amazon.com/dp/B001JM5OQ0?tag=${TAG}`,    wholeHouse:true },
  { id:11, category:'whole-house', name:'iSpring WGB32B',                brand:'iSpring',            type:'Whole-House 3-Stage Filter',   price:189, filterCostPerYear:60,  rating:4.6, reviews:7200,  gpd:null, stages:3, cert:['NSF/ANSI 42'],                                                             certColor:'#22d3ee', removes:['Sediment','Chlorine','Herbicides','Pesticides','Iron'],       bestFor:['Chlorine','Iron','Sediment','VOCs'],     pros:['Best budget whole-house pick','High flow rate','20" big-blue filters'],quickChange:false,expertPick:false, expertReason:'',                                                                                                                                              img:'https://m.media-amazon.com/images/I/81sB5VxJKRL._AC_SL1500_.jpg',  amazon:`https://www.amazon.com/s?k=iSpring+WGB32B+Whole+House+Water+Filter&tag=${TAG}`, wholeHouse:true },
  // ── SHOWER ───────────────────────────────────────────────────────────────────
  { id:12, category:'shower',      name:'AquaBliss SF100',               brand:'AquaBliss',          type:'Shower Filter',                price:26,  filterCostPerYear:52,  rating:4.4, reviews:64000, gpd:null, stages:1, cert:['Tested & verified'],                                                        certColor:'#22d3ee', removes:['Chlorine','Fluoride','Heavy metals','Bacteria','Sediment'],     bestFor:['Chlorine','Chloramine','Hard water'],    pros:['#1 bestselling shower filter','Fits any showerhead','All-in-one cartridge'], quickChange:true,  expertPick:true,  expertReason:"Amazon's #1 bestselling shower filter with 64,000+ verified reviews. Widely cited by dermatologists and beauty editors for improving skin & hair health after chlorine exposure.",  img:'https://m.media-amazon.com/images/I/71F9EYDNTPL._AC_SL1500_.jpg',  amazon:`https://www.amazon.com/s?k=AquaBliss+SF100+High+Output+Shower+Filter&tag=${TAG}`, shower:true },
  { id:13, category:'shower',      name:'Aquasana AQ-4100NSH',           brand:'Aquasana',           type:'Premium Shower Filter + Head', price:99,  filterCostPerYear:80,  rating:4.4, reviews:8900,  gpd:null, stages:2, cert:['NSF/ANSI 177'],                                                            certColor:'#d97706', removes:['Chlorine >91%','Chloramine','VOCs','Synthetic chemicals'],     bestFor:['Chlorine','Chloramine','VOCs'],          pros:['Only NSF/ANSI 177 certified shower filter','Includes showerhead'],  quickChange:true,  expertPick:false, expertReason:'',                                                                                                                                              img:'https://m.media-amazon.com/images/I/51k14C7-dDL._AC_SL1500_.jpg',  amazon:`https://www.amazon.com/s?k=Aquasana+AQ-4100+Premium+Shower+Filter&tag=${TAG}`,   shower:true },
];

const CATEGORIES = [
  { id:'pitcher',    icon:'🥤', label:'Pitcher & Pour-Through',   desc:'No installation needed — great for renters & travel' },
  { id:'countertop', icon:'🪣', label:'Countertop Filters',        desc:'Sits on your counter — no plumbing required' },
  ...
  return (
    <div style={{ background: highlight ? '#07131e' : '#060e17', border: `1px solid ${highlight ? '#0891b2' : '#0e2233'}`, borderRadius: 10, overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
      <div style={{ background: '#fff', height: 150, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 10, position: 'relative' }}>
        ...
        {p.expertPick && <div style={{ position: 'absolute', top: 6, right: 6, background: '#d97706', color: '#fff', fontSize: 10, padding: '2px 7px', borderRadius: 3, fontWeight: 800 }}>🏅 EXPERT PICK</div>}
        {!p.expertPick && highlight && <div style={{ position: 'absolute', top: 6, right: 6, background: '#0891b2', color: '#fff', fontSize: 10, padding: '2px 6px', borderRadius: 3, fontWeight: 800 }}>TOP PICK</div>}
        {p.quickChange && <div style={{ position: 'absolute', top: 6, left: 6, background: '#065f46', color: '#34d399', fontSize: 10, padding: '2px 6px', borderRadius: 3, fontWeight: 800 }}>⚡ QUICK-CHANGE</div>}
      </div>
      <div style={{ padding: '12px 14px', flex: 1, display: 'flex', flexDirection: 'column', gap: 7 }}>
        <div>
          <div style={{ fontSize: 12, color: '#475569', letterSpacing: 1, marginBottom: 2 }}>{p.brand.toUpperCase()}</div>
          <div style={{ fontSize: 14, fontWeight: 800, color: '#e2e8f0', lineHeight: 1.2 }}>{p.name}</div>
          <div style={{ fontSize: 13, color: '#475569', marginTop: 1 }}>{p.type}</div>
        </div>
        <div style={{ display: 'flex', alignItems: 'center', gap: 5 }}>
          <span style={{ color: '#f59e0b', fontSize: 14 }}>{'★'.repeat(Math.round(p.rating))}</span>
          <span style={{ fontSize: 12, color: '#94a3b8' }}>{p.rating} ({p.reviews.toLocaleString()})</span>
        </div>
        <div style={{ display: 'flex', gap: 3, flexWrap: 'wrap' }}>
          {p.cert.map((c: string) => (
            <span key={c} style={{ fontSize: 11, padding: '1px 5px', borderRadius: 3, background: p.certColor + '22', color: p.certColor, border: `1px solid ${p.certColor}44`, fontWeight: 700 }}>{c}</span>
          ))}
        </div>
        <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap' }}>
          {[p.gpd ? { l: 'GPD', v: p.gpd } : null, { l: 'Stages', v: p.stages }, { l: 'Filter/yr', v: `$${p.filterCostPerYear}` }, p.remineralize ? { l: 'Remineralizes', v: '✓' } : null].filter(Boolean).map((s: any) => (
            <div key={s.l} style={{ background: '#0a1929', borderRadius: 4, padding: '3px 7px', textAlign: 'center' }}>
              <div style={{ fontSize: 15, fontWeight: 800, color: '#22d3ee' }}>{s.v}</div>
              <div style={{ fontSize: 11, color: '#334155', letterSpacing: 1 }}>{s.l.toUpperCase()}</div>
            </div>
          ))}
        </div>
        <div style={{ flex: 1 }}>
          <div style={{ fontSize: 11, color: '#334155', letterSpacing: 1, marginBottom: 3 }}>REMOVES</div>
          <div style={{ display: 'flex', gap: 3, flexWrap: 'wrap' }}>
            {p.removes.slice(0, 3).map((r: string) => <span key={r} style={{ fontSize: 11, padding: '1px 5px', borderRadius: 3, background: '#051a0a', color: '#22d3ee', border: '1px solid #22d3ee22' }}>{r}</span>)}
          </div>
        </div>
        {p.expertReason && (
          <div style={{ background: '#0d1f0d', border: '1px solid #d9770633', borderRadius: 6, padding: '8px 10px', fontSize: 12, color: '#a3a3a3', lineHeight: 1.55, fontStyle: 'italic' }}>
            "{p.expertReason}"
          </div>
        )}
        {!p.expertReason && (
          <div style={{ display: 'flex', gap: 3, flexWrap: 'wrap' }}>
            {p.pros.slice(0, 2).map((pro: string) => <div key={pro} style={{ fontSize: 12, color: '#64748b' }}>✓ {pro}</div>)}
          </div>
        )}
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', paddingTop: 8, borderTop: '1px solid #0e2233' }}>
          <div>
            ...
            <div style={{ fontSize: 11, color: '#334155' }}>Amazon · Free ship</div>
          </div>
          <a href={p.amazon} target="_blank" rel="noreferrer" style={{ padding: '8px 13px', background: '#f59e0b', borderRadius: 6, color: '#000', fontSize: 13, fontWeight: 800, textDecoration: 'none' }}>Buy →</a>
        </div>
      </div>
    </div>
  );
...
export default function WaterCheckup() {
  ...
  // Always recommend the expert pick from each category — every home needs
  // chlorine, taste & odor protection regardless of what the test shows.
  const getRecommended = () =>
    CATEGORIES.map(cat => PRODUCTS.find((p: any) => p.category === cat.id && p.expertPick)).filter(Boolean);
      ...
      <div style={{ maxWidth: 680, margin: '44px auto 0', padding: '0 24px', textAlign: 'center' }}>
        ...
        {error && (
          <div style={{ marginTop: 20, padding: '14px 18px', background: '#1a0a0a', border: '1px solid #ef4444', borderRadius: 8, textAlign: 'left' }}>
            <div style={{ color: '#ef4444', fontSize: 15, fontWeight: 700, marginBottom: 5 }}>⚠ Error</div>
            <div style={{ color: '#fca5a5', fontSize: 14, wordBreak: 'break-word', lineHeight: 1.7 }}>{error}</div>
          </div>
        )}
      </div>
          ...
          {tab === 'cost' && (
            <div style={{ background: '#0a1929', border: '1px solid #0e2233', borderTop: 'none', borderRadius: '0 0 12px 12px', padding: 24 }}>
              ...
              <div style={{ display: 'flex', gap: 20, flexWrap: 'wrap', marginBottom: 24, alignItems: 'flex-end' }}>
                ...
                <div>
                  <div style={{ fontSize: 12, color: '#64748b', marginBottom: 5 }}>YEARS: {years}</div>
                  <input type="range" min={1} max={10} value={years} onChange={e => setYears(+e.target.value)} style={{ width: 130, accentColor: '#0891b2' }} />
                </div>
                <div>
                  <div style={{ fontSize: 12, color: '#64748b', marginBottom: 5 }}>HOUSEHOLD: {ppl}</div>
              ...
              <div style={{ display: 'flex', gap: 14, marginTop: 14, flexWrap: 'wrap' }}>
                {[
                  ...
                  <div key={s.l} style={{ flex: 1, minWidth: 90, background: '#060e17', border: `1px solid ${s.c}33`, borderRadius: 8, padding: '12px 16px' }}>
                    <div style={{ fontSize: 12, color: '#64748b', marginBottom: 3 }}>{s.l}</div>
                    <div style={{ fontSize: 20, fontWeight: 800, color: s.c }}>{s.v}</div>
                    <div style={{ fontSize: 12, color: '#334155' }}>over {years} yr{years !== 1 ? 's' : ''}</div>
                  </div>
                ))}
              </div>
            </div>
