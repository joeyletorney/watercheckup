...
const PRODUCTS: any[] = [
  ...
  { id:38, cat:'whole', catLabel:'Whole-House', name:'SpringWell WS4 Well Water Filter', brand:'SpringWell', price:899, filterCostPerYear:85, rating:4.8, reviews:1200, gpd:null, stages:3, cert:['NSF/ANSI 42','WQA tested'], certColor:'#d97706', removes:['Iron >99%','Manganese >99%','Hydrogen Sulfide','Sediment','Odor'], bestFor:['Iron','Manganese','Sulfur','Sediment'], pros:['Built for well water','Air injection — no chemicals','Removes rotten-egg smell'], diyDiff:'Hard', situations:['homeowner'], well:true, wholeHouse:true, img:'https://watertechadvice.com/wp-content/uploads/2022/04/springwell-ws1-ws4-whole-house-well-filter-review-ft-img-1200x900.jpg', amazon:`https://www.amazon.com/dp/B09NGDLQT6?tag=${TAG}` },
