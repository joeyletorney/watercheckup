  ...
  return (
    <div style={{ background: highlight ? '#07131e' : '#060e17', border: `1px solid ${highlight ? '#0891b2' : '#0e2233'}`, borderRadius: 10, overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
      <div style={{ background: '#fff', height: 150, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 10, position: 'relative' }}>
        ...
        {highlight && <div style={{ position: 'absolute', top: 6, right: 6, background: '#0891b2', color: '#fff', fontSize: 11, padding: '2px 6px', borderRadius: 3, fontWeight: 800 }}>TOP PICK</div>}
        {p.tankless && <div style={{ position: 'absolute', top: 6, left: 6, background: '#7c3aed', color: '#fff', fontSize: 11, padding: '2px 6px', borderRadius: 3, fontWeight: 800 }}>TANKLESS</div>}
      </div>
