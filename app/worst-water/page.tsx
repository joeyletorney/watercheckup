    ...
    <div style={{ minHeight: '100vh', color: '#e2e8f0', fontFamily: "'Inter', sans-serif" }}>
      ...
      <div style={{ maxWidth: 800, margin: '0 auto', padding: '40px 24px 80px' }}>
        ...
        <div style={{ marginBottom: 48 }}>
          ...
          <div style={{ padding: '14px 18px', background: '#ef444412', border: '1px solid #ef444430', borderRadius: 8, fontSize: 13, color: '#cbd5e1', lineHeight: 1.6 }}>
                ...
                <div key={sys.id} style={{
                  ...
                  <div>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 4, flexWrap: 'wrap' }}>
                      ...
                      <span style={{ fontSize: 13, padding: '2px 8px', background: '#071828', border: '1px solid #1a3a5c', borderRadius: 4, color: '#cbd5e1' }}>
                        {sys.stateName}
                      </span>
                      <span style={{ fontSize: 13, padding: '2px 8px', background: `${rankColor}15`, border: `1px solid ${rankColor}40`, borderRadius: 4, color: rankColor, fontWeight: 700 }}>
                        {sys.violations} MCL violation{sys.violations !== 1 ? 's' : ''}
                      </span>
                    </div>
                    <div style={{ fontSize: 13, color: '#a8b4c4', lineHeight: 1.5 }}>
                      Worst: <span style={{ color: '#cbd5e1', fontWeight: 600 }}>{sys.worstCompound?.[0]}</span> at <span style={{ color: rankColor, fontWeight: 700 }}>{sys.worstCompound?.[1].toFixed(1)} ppt</span>
                  ...
                  <div style={{ textAlign: 'right', flexShrink: 0 }}>
                    ...
                    <div style={{ fontSize: 13, color: '#a8b4c4' }}>ppt max</div>
                  </div>
                </div>
              );
            })}
