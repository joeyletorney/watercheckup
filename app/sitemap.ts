...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const pinned: MetadataRoute.Sitemap = [
    ...
    { url: `${base}/blog/san-antonio-water-quality`, lastModified: now, changeFrequency: 'monthly', priority: 0.88 },
    { url: `${base}/blog/pfas-in-san-antonio-water`, lastModified: now, changeFrequency: 'monthly', priority: 0.87 },
