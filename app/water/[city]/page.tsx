...
const TOP_PICKS: Record<string, { label: string; product: string; reason: string; link: string; amazon: string }> = {
  'chicago':       { label: 'Lead detected in tap water', product: 'Waterdrop Under-Sink RO', reason: 'Removes 99.9% of lead from Chicago service lines', link: 'https://www.waterdropfilter.com/products/tankless-reverse-osmosis-system-wd-g3p800-w-fc-1?ref=anbyjkqb', amazon: 'https://www.amazon.com/s?k=under+sink+ro+lead+filter&tag=watercheck20-20' },
  'los-angeles':   { label: 'Chromium-6 & PFAS detected', product: 'Waterdrop Under-Sink RO', reason: 'Only RO removes chromium-6 — carbon filters do not', link: 'https://www.waterdropfilter.com/products/tankless-reverse-osmosis-system-wd-g3p800-w-fc-1?ref=anbyjkqb', amazon: 'https://www.amazon.com/s?k=under+sink+ro+chromium+pfas&tag=watercheck20-20' },
  'houston':       { label: 'Elevated THMs in tap water', product: 'Waterdrop Under-Sink Filter', reason: 'Carbon block filtration removes THMs and chloramine byproducts', link: 'https://www.waterdropfilter.com/products/tankless-reverse-osmosis-system-wd-g3p800-w-fc-1?ref=anbyjkqb', amazon: 'https://www.amazon.com/s?k=under+sink+water+filter+thm&tag=watercheck20-20' },
  'new-york':      { label: 'Lead risk from building pipes', product: 'Waterdrop Pitcher Filter', reason: 'NSF 53 certified for lead — no installation needed', link: 'https://www.waterdropfilter.com/products/tankless-reverse-osmosis-system-wd-g3p800-w-fc-1?ref=anbyjkqb', amazon: 'https://www.amazon.com/s?k=water+filter+pitcher+lead+nsf+53&tag=watercheck20-20' },
  'phoenix':       { label: 'PFAS + high TDS detected', product: 'Waterdrop Under-Sink RO', reason: 'RO removes PFAS, arsenic, TDS, and hard minerals in one system', link: 'https://www.waterdropfilter.com/products/tankless-reverse-osmosis-system-wd-g3p800-w-fc-1?ref=anbyjkqb', amazon: 'https://www.amazon.com/s?k=reverse+osmosis+pfas+arsenic&tag=watercheck20-20' },
  'philadelphia':  { label: 'PFAS from Delaware River', product: 'Waterdrop Under-Sink RO', reason: 'RO is the only residential technology proven to remove PFAS', link: 'https://www.waterdropfilter.com/products/tankless-reverse-osmosis-system-wd-g3p800-w-fc-1?ref=anbyjkqb', amazon: 'https://www.amazon.com/s?k=under+sink+ro+pfas+certified&tag=watercheck20-20' },
  'san-antonio':   { label: 'Hard water + DBP violations', product: 'Waterdrop Under-Sink RO', reason: 'RO removes hard minerals, DBPs, and chlorine in one pass', link: 'https://www.waterdropfilter.com/products/tankless-reverse-osmosis-system-wd-g3p800-w-fc-1?ref=anbyjkqb', amazon: 'https://www.amazon.com/s?k=reverse+osmosis+hard+water&tag=watercheck20-20' },
  'dallas':        { label: 'Elevated THMs + HAA5', product: 'Waterdrop Under-Sink Filter', reason: 'Certified carbon block for THMs and haloacetic acid removal', link: 'https://www.waterdropfilter.com/products/tankless-reverse-osmosis-system-wd-g3p800-w-fc-1?ref=anbyjkqb', amazon: 'https://www.amazon.com/s?k=under+sink+carbon+filter+thm+haa&tag=watercheck20-20' },
  'miami':         { label: 'PFAS + aging infrastructure', product: 'Waterdrop Under-Sink RO', reason: 'Full RO protection for PFAS and heavy metals from old pipes', link: 'https://www.waterdropfilter.com/products/tankless-reverse-osmosis-system-wd-g3p800-w-fc-1?ref=anbyjkqb', amazon: 'https://www.amazon.com/s?k=reverse+osmosis+pfas+lead&tag=watercheck20-20' },
  'seattle':       { label: 'Building pipe lead risk', product: 'Waterdrop Pitcher Filter', reason: "Seattle source water is great — in-building pipes are the risk", link: 'https://www.waterdropfilter.com/products/tankless-reverse-osmosis-system-wd-g3p800-w-fc-1?ref=anbyjkqb', amazon: 'https://www.amazon.com/s?k=water+filter+pitcher+lead+certified&tag=watercheck20-20' },
};

const DEFAULT_PICK = { label: 'Contaminants detected in local water', product: 'Waterdrop Under-Sink RO', reason: 'The gold standard for removing PFAS, lead, chlorine, and more', link: 'https://www.waterdropfilter.com/products/tankless-reverse-osmosis-system-wd-g3p800-w-fc-1?ref=anbyjkqb', amazon: 'https://www.amazon.com/s?k=under+sink+reverse+osmosis&tag=watercheck20-20' };
