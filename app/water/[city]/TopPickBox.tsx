        ...
        {picks.map((pick, i) => {
          ...
          return (
            <div key={i} style={{
              ...
              gap: 12, flexWrap: 'wrap', padding: '14px 16px',
              ...
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: 10, flex: 1, minWidth: 180 }}>
                ...
                <div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap' }}>
                    ...
                    {pick.badge && (
                      <span style={{ fontSize: 9, fontWeight: 800, letterSpacing: 1, background: i === 0 ? '#0891b2' : '#1e3a5f', color: '#fff', padding: '2px 7px', borderRadius: 4 }}>
                        {pick.badge}
                      </span>
                    )}
                  </div>
