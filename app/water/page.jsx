...
export const metadata = {
  ...
  description:
    'Free EPA-based tap water quality reports for 135+ US cities. Check PFAS levels, lead violations, contaminant data, and filter recommendations for your city.',
};
