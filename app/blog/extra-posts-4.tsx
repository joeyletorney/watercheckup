...
export const EXTRA_POSTS_4: Record<string, Post> = {
  ...
  'best-ro-system-for-pfas-removal': {
    ...
    content: React.createElement(React.Fragment, null,
      ...
      React.createElement('h3', { style: h3Style }, 'Waterdrop G3P600 -- Best overall'),
      React.createElement('p', { style: pStyle },
        'The G3P600 is tankless, meaning no bulky reservoir under your sink. At 600 gallons per day it runs fast -- no waiting. NSF 58 certified, removes PFAS, lead, nitrates, arsenic, and chloramine byproducts. Typically runs around $439 and installs in under an hour with no plumber needed. This is what most WaterCheckup users end up with.'
      ),
