...
> = {
  ...
  'waterdrop-k19s-vs-aquatru-classic': {
    ...
    excerpt: 'Both plug in, both remove PFAS. The AquaTru costs $226 more. Here\'s whether that extra money is worth it — certifications, tank size, and long-term filter costs compared.',
    date: 'June 1, 2026',
    readTime: '7 min read',
    badge: 'Comparison',
    badgeColor: '#0891b2',
  ...
  'best-water-filter-gaithersburg-md': {
    ...
    excerpt: 'WSSC water has PFAS detected, Potomac River DBPs, and lead risk in older homes. Here\'s what EPA data shows and the exact filter for Gaithersburg residents.',
    date: 'June 1, 2026',
    readTime: '7 min read',
    badge: 'Local',
    badgeColor: '#059669',
  ...
  'best-whole-house-water-filter': {
    ...
    excerpt: 'Protect every tap, shower, and appliance. The top whole-house systems ranked by NSF certifications, contaminant removal, and long-term cost.',
    date: 'June 1, 2026',
    readTime: '10 min read',
    badge: 'Home',
    badgeColor: '#7c3aed',
    ...
    <div style={{ minHeight: '100vh', color: '#e2e8f0', fontFamily: "'Inter', sans-serif" }}>
      ...
      <div style={{ maxWidth: 860, margin: '0 auto', padding: '48px 24px 80px' }}>
        ...
        <div style={{ marginBottom: 96 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: 16 }}>
            {featuredPosts.map(post => (
              <Link prefetch key={post.slug} href={`/blog/${post.slug}`} style={{ textDecoration: 'none' }}>
        ...
        <div style={{ marginTop: 96, padding: '28px', background: 'linear-gradient(135deg,#071828,#040d14)', border: '1px solid #0f2d40', borderRadius: 16, textAlign: 'center' }}>
          ...
          <Link prefetch href="/" style={{ display: 'inline-block', padding: '12px 28px', background: 'linear-gradient(135deg,#0891b2,#06b6d4)', borderRadius: 10, color: '#fff', fontSize: 15, fontWeight: 700, textDecoration: 'none' }}>
            Check My Water Free →
          </Link>
        </div>
