...
const TOP_3_RO = [
  ...
  { product: 'AquaTru Under-Sink RO', brand: 'AquaTru', price: '~$375', reason: 'NSF 42/53/58 certified. Quick-change filters, no tools needed. Compact tankless design.', link: 'https://www.aquatruwater.com/products/aquatru-under-sink', amazon: `https://www.amazon.com/dp/B0BVWB1Y7G?tag=${AMAZON_TAG}`, badge: 'EASIEST FILTER CHANGE' },
];
const TOP_3_PITCHER = [
...
const RECS: Record<string, Rec> = {
  ...
  'city-pfas-owner_full':     { title: 'Waterdrop RO + Whole-House Pre-Filter', tagline: 'Full-home pre-filter + point-of-use RO. Maximum coverage.', why: 'Pair a whole-house sediment filter at entry with a dedicated RO at the kitchen tap. Covers drinking, cooking, and ice.', cta: 'Get on Waterdrop', cta2: 'Whole House on Amazon', link: LINKS.waterdrop, link2: LINKS.amazon_whole_house, badge: 'MAXIMUM PROTECTION', badgeColor: '#0066cc' , alts: TOP_3_RO},
  ...
  'city-lead-owner_full':     { title: 'Whole-House + Under-Sink RO', tagline: 'Protect every tap. Full lead removal from entry to glass.', why: 'If your home has aging pipes throughout, a whole-house pre-filter plus a dedicated kitchen RO is the complete solution.', cta: 'Under-Sink on Waterdrop', cta2: 'Whole House on Amazon', link: LINKS.waterdrop, link2: LINKS.amazon_whole_house, badge: 'WHOLE HOME', badgeColor: '#7c3aed' , alts: TOP_3_RO},
  ...
  'well-pfas-owner_full':     { title: 'Whole-House Well System + RO', tagline: 'Iron filter + softener + RO. Complete well protection.', why: 'Full protection for well homeowners means treating at entry (iron, sediment, bacteria) and again at the tap (PFAS, nitrates).', cta: 'Get on Waterdrop', cta2: 'See on Amazon', link: LINKS.waterdrop, link2: LINKS.amazon_well, badge: 'MAXIMUM WELL', badgeColor: '#14532d' , alts: TOP_3_RO},
  ...
  'well-lead-owner_full':     { title: 'Whole-House Well + RO System', tagline: 'Iron filtration + lead removal at every tap.', why: 'For full protection on well water, pair entry-level iron and sediment filtration with a dedicated kitchen RO.', cta: 'Get on Waterdrop', cta2: 'See on Amazon', link: LINKS.waterdrop, link2: LINKS.amazon_well, badge: 'WHOLE WELL HOME', badgeColor: '#78350f' , alts: TOP_3_RO},
                ...
                {rec.alts.map((alt: any, i: number) => (
                  <div key={i} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 10, flexWrap: 'wrap', padding: '12px 14px', background: i === 0 ? 'rgba(8,145,178,0.08)' : 'rgba(255,255,255,0.02)', borderRadius: 10, border: i === 0 ? '1px solid rgba(8,145,178,0.3)' : '1px solid #0f2336' }}>
                    <div style={{ flex: 1, minWidth: 160 }}>
                      ...
                      <div style={{ fontSize: 11, color: '#94a3b8', marginTop: 2 }}>{alt.brand} · {alt.price}</div>
