...
const TOP_3_RO = [
  ...
  { product: 'Waterdrop G3P600 RO', brand: 'Waterdrop', price: '~$439', reason: 'Tankless under-sink RO with smart LED TDS faucet. NSF 42/53/58/372, 600 GPD, removes 99%+ PFAS and lead. Best value under-sink RO.', link: `https://www.waterdropfilter.com/products/waterdrop-reverse-osmosis-water-filtration-system?ref=${WATERDROP_TAG}`, amazon: `https://www.amazon.com/dp/B07P1XFYJP?tag=${AMAZON_TAG}`, badge: 'BEST VALUE', certs: ['NSF 42', 'NSF 53', 'NSF 58', 'NSF 372'] },
...
const LINKS = {
  waterdrop: `https://www.waterdropfilter.com/products/waterdrop-reverse-osmosis-water-filtration-system?ref=${WATERDROP_TAG}`,
...
const RECS: Record<string, Rec> = {
  'city-pfas-renter':         { title: 'Waterdrop K19-S Countertop RO', tagline: 'Plug-in RO removes 99%+ PFAS. Zero installation. NSF 58 certified.', why: 'PFAS require reverse osmosis — the only certified technology. The K19-S plugs in like an appliance, no plumbing needed. NSF 42/53/58 certified.', cta: 'Get on Waterdrop', cta2: 'See on Amazon', link: `https://www.waterdropfilter.com/products/countertop-ro-water-filter-system-wd-k19-s?ref=${WATERDROP_TAG}`, link2: `https://www.amazon.com/dp/B0BHQRNGZ8?tag=${AMAZON_TAG}`, badge: 'PFAS CERTIFIED', badgeColor: '#0891b2', alts: TOP_3_PITCHER },
  'city-pfas-owner_simple':   { title: 'Waterdrop G3P600 RO', tagline: 'NSF 58 certified. 99%+ PFAS removal. Installs under the sink in 30 min.', why: 'Under-sink RO is the gold standard for PFAS. The G3P600 is tankless, fast (600 GPD), and NSF 58 certified — the standard that covers reverse osmosis performance.', cta: 'Get on Waterdrop', cta2: 'See on Amazon', link: LINKS.waterdrop, link2: LINKS.amazon_undersink, badge: 'BEST FOR PFAS', badgeColor: '#0891b2', alts: TOP_3_RO },
  ...
  'city-lead-renter':         { title: 'Waterdrop K19-S Countertop RO', tagline: 'Plug-in RO removes 99%+ lead. No install needed. NSF 58 certified.', why: 'Lead enters through old building pipes. The K19-S removes lead at 99%+ via reverse osmosis — no installation, no landlord permission required.', cta: 'Get on Waterdrop', cta2: 'See on Amazon', link: `https://www.waterdropfilter.com/products/countertop-ro-water-filter-system-wd-k19-s?ref=${WATERDROP_TAG}`, link2: `https://www.amazon.com/dp/B0BHQRNGZ8?tag=${AMAZON_TAG}`, badge: 'LEAD CERTIFIED', badgeColor: '#d97706', alts: TOP_3_PITCHER },
  'city-lead-owner_simple':   { title: 'Waterdrop G3P600 RO', tagline: 'NSF 58 certified. Removes 99.9% of lead at the tap.', why: 'Homes built before 1986 likely have lead solder or pipes. An NSF 58 certified under-sink RO removes lead at the point of use — the safest approach for cooking and drinking.', cta: 'Get on Waterdrop', cta2: 'See on Amazon', link: LINKS.waterdrop, link2: LINKS.amazon_undersink, badge: 'LEAD CERTIFIED', badgeColor: '#d97706', alts: TOP_3_RO },
  ...
  'city-general-renter':      { title: 'Waterdrop K19-S Countertop RO', tagline: 'NSF 42/53/58. Removes PFAS, lead, arsenic, 1,000+ contaminants. No install.', why: 'The K19-S is the most versatile no-install filter — RO-grade removal of virtually everything in a countertop unit that plugs into any outlet.', cta: 'Get on Waterdrop', cta2: 'See on Amazon', link: `https://www.waterdropfilter.com/products/countertop-ro-water-filter-system-wd-k19-s?ref=${WATERDROP_TAG}`, link2: `https://www.amazon.com/dp/B0BHQRNGZ8?tag=${AMAZON_TAG}`, badge: 'ALL-IN-ONE', badgeColor: '#cbd5e1', alts: TOP_3_PITCHER },
  'city-general-owner_simple':{ title: 'Waterdrop G3P600 RO', tagline: 'NSF 42/53/58 certified. Removes 1000+ contaminants.', why: 'Reverse osmosis handles everything — PFAS, lead, nitrates, arsenic, chlorine, and more. The gold standard for home filtration and the most cost-effective per-gallon option long-term.', cta: 'Get on Waterdrop', cta2: 'See on Amazon', link: LINKS.waterdrop, link2: LINKS.amazon_undersink, badge: 'MOST COMPLETE', badgeColor: '#cbd5e1', alts: TOP_3_RO },
  ...
  'well-pfas-renter':         { title: 'Waterdrop K19-S Countertop RO', tagline: 'Plug-in RO removes 99%+ PFAS from well water. No install needed.', why: 'Well PFAS contamination is common near agriculture and military sites. The K19-S uses reverse osmosis — the only certified PFAS technology — with zero plumbing required.', cta: 'Get on Waterdrop', cta2: 'See on Amazon', link: `https://www.waterdropfilter.com/products/countertop-ro-water-filter-system-wd-k19-s?ref=${WATERDROP_TAG}`, link2: `https://www.amazon.com/dp/B0BHQRNGZ8?tag=${AMAZON_TAG}`, badge: 'WELL PFAS', badgeColor: '#166534', alts: TOP_3_PITCHER },
  'well-pfas-owner_simple':   { title: 'Waterdrop G3P600 RO', tagline: 'NSF 58 certified. Removes 99%+ PFAS. Handles well water hardness.', why: 'Well water needs filters rated for higher sediment and mineral content in addition to PFAS. The G3P600 handles all of it at the kitchen tap.', cta: 'Get on Waterdrop', cta2: 'See on Amazon', link: LINKS.waterdrop, link2: LINKS.amazon_well, badge: 'WELL + PFAS', badgeColor: '#166534', alts: TOP_3_RO },
  ...
  'well-lead-renter':         { title: 'Waterdrop K19-S Countertop RO', tagline: 'Plug-in RO removes lead, arsenic, heavy metals. NSF 58 certified.', why: 'Lead and heavy metals in well water require certified filtration. The K19-S removes them via reverse osmosis with zero installation required.', cta: 'Get on Waterdrop', cta2: 'See on Amazon', link: `https://www.waterdropfilter.com/products/countertop-ro-water-filter-system-wd-k19-s?ref=${WATERDROP_TAG}`, link2: `https://www.amazon.com/dp/B0BHQRNGZ8?tag=${AMAZON_TAG}`, badge: 'WELL + LEAD', badgeColor: '#92400e', alts: TOP_3_WELL },
  'well-lead-owner_simple':   { title: 'Waterdrop G3P600 RO', tagline: 'Removes lead, iron, manganese, and heavy metals. NSF 58.', why: 'Well water lead often comes from natural deposits or old pump hardware. An NSF 58 certified RO system handles it at the tap with no risk of re-contamination.', cta: 'Get on Waterdrop', cta2: 'See on Amazon', link: LINKS.waterdrop, link2: LINKS.amazon_well, badge: 'WELL + LEAD', badgeColor: '#92400e', alts: TOP_3_RO },
  ...
  'well-general-renter':      { title: 'Waterdrop K19-S Countertop RO', tagline: 'Plug-in RO handles well water contaminants. NSF 42/53/58. No install.', why: 'Well water needs more than a basic pitcher. The K19-S uses reverse osmosis to handle nitrates, arsenic, PFAS, heavy metals, and iron byproducts with zero installation.', cta: 'Get on Waterdrop', cta2: 'See on Amazon', link: `https://www.waterdropfilter.com/products/countertop-ro-water-filter-system-wd-k19-s?ref=${WATERDROP_TAG}`, link2: `https://www.amazon.com/dp/B0BHQRNGZ8?tag=${AMAZON_TAG}`, badge: 'WELL COMPLETE', badgeColor: '#1e3a5f', alts: TOP_3_WELL },
  'well-general-owner_simple':{ title: 'Waterdrop G3P600 RO', tagline: 'NSF 42/53/58 certified. Built for well water. Removes everything.', why: 'Private wells need specialized filtration. RO handles the full range of well water contaminants — iron byproducts, nitrates, arsenic, PFAS, heavy metals, and more.', cta: 'Get on Waterdrop', cta2: 'See on Amazon', link: LINKS.waterdrop, link2: LINKS.amazon_well, badge: 'WELL COMPLETE', badgeColor: '#1e3a5f', alts: TOP_3_RO },
    ...
    <div style={{ minHeight: '100vh', color: '#e2e8f0', fontFamily: "'Inter', sans-serif" }}>
      ...
      <div style={{ maxWidth: 680, margin: '0 auto', padding: '48px 24px 100px' }}>
        ...
        <div style={{ marginBottom: 72, padding: '24px 22px', background: '#071828', border: '1px solid #1a3a5c', borderRadius: 12 }}>
          ...
          <Link prefetch href="/" style={{ display: 'inline-block', marginTop: 14, padding: '10px 20px', background: 'linear-gradient(135deg,#0891b2,#06b6d4)', color: '#fff', borderRadius: 8, fontSize: 13, fontWeight: 800, textDecoration: 'none' }}>Check My Water Report →</Link>
        </div>
